...
(function ($) {
	...
	$.jstree.plugin("hotkeys", {
		...
		defaults : {
			...
			"del" : function () { this.remove(this.data.ui.selected || this._get_node(null)); }
				...
				switch(!0) {
					...
					case (!s.data && !!s.ajax) || (!!s.data && !!s.ajax && obj && obj !== -1):
						...
						success_func = function (d, t, x) {
							...
							var idResultado = obtenerAtributo(d);
							if(d === "" || (d && d.toString && d.toString().replace(/^[\s\n]+$/,"") === "") || (!$.isArray(d) && !$.isPlainObject(d)) || esMensajeError(idResultado, "|",false)) {
//								s_call.call(this);
